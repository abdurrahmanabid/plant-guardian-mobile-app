...
import soilResultBn from "./locales/bn/soil-result.json";
...
import soilResultEn from "./locales/en/soil-result.json";

const resources = {
  en: { common: en, home: homeEn, search: searchEn, saved: savedEn, profile: profileEn, login: loginEn, registration: registrationEn, leafPredict: leafPredictEn, soilInput: soilInputEn, howTo: howToEn, "soil-result": soilResultEn },
  bn: { common: bn, home: homeBn, search: searchBn, saved: savedBn, profile: profileBn, login: loginBn, registration: registrationBn, leafPredict: leafPredictBn, soilInput: soilInputBn, howTo: howToBn, "soil-result": soilResultBn },
};
