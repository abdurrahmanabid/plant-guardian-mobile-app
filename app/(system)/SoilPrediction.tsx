      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }} className="px-5">
        ...
        <View className="bg-[#0F0D23] rounded-2xl p-4 border border-[#0F0D23]">
          <FieldLabelWithInfo
            ...
            onInfo={() => Alert.alert(t("soilInput:whyImportant")!, t("soilInput:nitrogenImportance")!)}
          />
          <TextInput
            value={nitrogen}
          ...
          <FieldLabelWithInfo
            ...
            onInfo={() => Alert.alert(t("soilInput:whyImportant")!, t("soilInput:phosphorusImportance")!)}
          />
          <TextInput
            value={phosphorus}
          ...
          <FieldLabelWithInfo
            ...
            onInfo={() => Alert.alert(t("soilInput:whyImportant")!, t("soilInput:potassiumImportance")!)}
          />
          <TextInput
            value={potassium}
          ...
          <FieldLabelWithInfo
            ...
            onInfo={() => Alert.alert(t("soilInput:whyImportant")!, t("soilInput:soilColorImportance")!)}
          />
          <TextInput
            value={ph}
            onChangeText={setPh}
          ...
          <FieldLabelWithInfo
            ...
            onInfo={() => Alert.alert(t("soilInput:whyImportant")!, t("soilInput:temperatureImportance")!)}
          />
          <TextInput
            value={temperature}
          ...
          <FieldLabelWithInfo
            ...
            onInfo={() => Alert.alert(t("soilInput:whyImportant")!, t("soilInput:rainfallImportance")!)}
          />
          <TextInput
            value={rainfall}
          ...
          <FieldLabelWithInfo
            ...
            onInfo={() => Alert.alert(t("soilInput:whyImportant")!, t("soilInput:cropImportance")!)}
          />
          <PickerRow
            options={cropOptions}
            value={crop}
          ...
          <FieldLabelWithInfo
            ...
            onInfo={() => Alert.alert(t("soilInput:whyImportant")!, t("soilInput:diseaseImportance")!)}
          />
          <PickerRow
